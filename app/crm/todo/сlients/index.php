    ...
    <div class="row justify-content-center col-md-5">
        <form action="/crm/todo/clients/searchClient" method="post">
            <div class="input-group">
                ...
                <button type="submit" class="b"><i class="fa-solid fa-search"></i></button>
            </div>
        </form>
    </div>
    <table class="table table-striped table-hover rounded-table rounded-table">
        ...
        <tbody>
            <?php foreach($clients as $client): ?>
                ...
                <td><?php echo $client['bonus_mapus_class']; ?></td>
