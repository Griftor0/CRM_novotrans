...
<div class="container d-flex flex-column justify-content-center align-items-center">
    <h1 class="my-4">Редактировать страницу</h1>
    <form method="POST" action="/crm/pages/updatePage">
        <div style="background: #ededee; padding: 30px; width: 500px; border-radius: 20px; border: 2px solid rgba(255, 255, 255, 0.5) ">
            ...
            <div class="mb-3">
                ...
                <?php
                    $pageRole = explode(",", $page['roles']); 
                    foreach($roles as $role): 
                ?>
                    <div class="mb-3">
                        <input class="form-check-input" type="checkbox" name="roles[]" value="<?=$role['id'];?>" <?php echo in_array($role['id'], $pageRole) ? 'checked' : '';?>>
